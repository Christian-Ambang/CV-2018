<?php 
	header("location: /PDF/Ambang-Christian-CV-apprentissage.pdf");
?>
<html>
<head>		
...
<?php
    ...
    if ($_GET['utm_source']!="" && isset($_GET['utm_source'])) {
       ...
       //var_dump($rqId);
        ...
        $source="/contact/autoreply-apprentissage.php";
    ...
    if($email!="" && isset($email) && $autoreplyStatut!="true" && $_GET["autoreply"]!="false"){
     ...
     $to      = "$email";
     $objet = 'Autoreply Candidature Integrateur Web Contrat Apprentissage';
